    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("S", "Subscribed"), ("I", "Ignored")], default="S"
                    ),
                ),
                (
                    "tag",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("F", "Followed"), ("B", "Blocked")], default="F"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("S", "Subscribed"), ("J", "Joined")], default="S"
                    ),
                ),
                (
                    "community",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, through="users.UserCommunity", to="communities.community"
            ),
        ),
        migrations.AddField(
            model_name="userpublic",
        ...
        migrations.AddField(
            ...
            name="tags",
            field=models.ManyToManyField(
                blank=True, through="users.UserTag", to="posts.tag"
            ),
        ),
        migrations.AddField(
            model_name="userpublic",
